...
while running:
    ...
    if pg.mouse.get_pressed()[0]:
        # Move the circl smoothly
        if event.type == pg.MOUSEMOTION:
            pos = pg.mouse.get_pos()
            direction_x = pos[0] - player_position.x
            direction_y = pos[1] - player_position.y
            player_position.x += direction_x * delta_time * 5
            player_position.y += direction_y * delta_time * 5

    # Use the mouse ...
    # if event.type == pg.MOUSEBUTTONDOWN:
    #     pos = pg.mouse.get_pos()
    #     # Move the circle
    #     player_position.x = pos[0]
    #     player_position.y = pos[1]
    # if event.type == pg.MOUSEBUTTONUP:
    #     pos = pg.mouse.get_pos()
    #     pg.draw.circle(screen, "red", player_position, 20)
    # # Motion
    # if event.type == pg.MOUSEMOTION:
    #     pos = pg.mouse.get_pos()
    #     player_position.x = pos[0]
